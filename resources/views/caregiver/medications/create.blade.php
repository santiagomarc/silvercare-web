                ...
                <div class="p-8">
                    ...
                    <form method="POST" action="{{ route('caregiver.medications.store') }}" id="medicationForm">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm" placeholder="e.g. Lisinopril, Metformin" required>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <div class="flex">
                                    <input type="text" name="dosage" id="dosage" value="{{ old('dosage') }}" class="w-2/3 rounded-l-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm" placeholder="e.g. 10, 500" required>
                            ...
                            <div>
                                ...
                                <input type="date" name="start_date" id="start_date" value="{{ old('start_date', date('Y-m-d')) }}" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm">
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="instructions" id="instructions" rows="3" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm" placeholder="e.g. Take with food, do not crush, avoid grapefruit...">{{ old('instructions') }}</textarea>
                        </div>
                        ...
                        <div class="mb-8 bg-gray-50 p-4 rounded-lg border border-gray-200">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="track_inventory" id="track_inventory" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" {{ old('track_inventory') ? 'checked' : '' }}>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="number" name="current_stock" id="current_stock" value="{{ old('current_stock') }}" min="0" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm text-sm" placeholder="e.g. 30">
                                </div>
                                <div>
                                    <label for="low_stock_threshold" class="block text-xs font-medium text-gray-500 mb-1">Low Stock Alert At</label>
                                    <input type="number" name="low_stock_threshold" id="low_stock_threshold" value="{{ old('low_stock_threshold', 5) }}" min="0" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm text-sm">
                                </div>
                            </div>
                        </div>
